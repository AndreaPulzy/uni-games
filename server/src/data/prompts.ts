...
export const PROMPT_BASTARDI: string[] = [
  ...
  'La frase piu inquietante da leggere in ascensore',
  ...
  'Cosa trovi nel cassetto piu disordinato di casa tua',
...
export const MEME_TEMPLATES: MemeTemplate[] = [
  ...
  { id: 'cervello-galattico', scena: 'Un cervello che si illumina sempre di piu a ogni livello di genialata', art: '🧠✨', topLabel: 'Idea normale', bottomLabel: 'Idea da cervello galattico' },
  ...
  { id: 'nonno-simpson', scena: 'Un vecchio che entra in un locale, si guarda intorno e se ne va subito', art: '👴🚶', topLabel: 'Entra', bottomLabel: 'Esce perche' },
  ...
  { id: 'trofeo-partecipazione', scena: 'Una premiazione dove il terzo classificato sembra il piu felice', art: '🥉🎉', topLabel: 'Il vincitore', bottomLabel: 'Il terzo' },
